# -*- coding: utf-8 -*-
#
# pytest-ansible-units documentation build configuration file, created by
...
project = 'pytest-ansible-units'
copyright = '2015, Bradley A. Thornton'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-ansible-units Documentation',
     [author], 1)
]
